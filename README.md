...
（All annual ROE calculations are derived from audited fiscal year-end financial statements published every December for Chinese A-share firms.The five-year average ROE (2020–2024) is computed consistently based on uniform December year-end accounting caliber across the whole sample period.）
...
- **Sample Scale**: Starting from over 29,000 raw firm-year observations, after aggregation, matching and rigorous data cleaning, the final valid research sample covers more than 5,000 unique A-share listed enterprises.

- **Rationale for Time Matching Design**：This study adopts a **forward-looking explanatory perspective** in variable alignment. 
We use the most recent 2025 ESG disclosure score as the comprehensive sustainability positioning of a firm, and match it against the firm’s **5-year historical average ROE (2020–2024)**.
All annual ROE calculations are derived from audited fiscal year-end financial statements published every December for Chinese A-share firms.
The five-year average ROE (2020–2024) is computed consistently based on uniform December year-end accounting caliber across the whole sample period.
...
3. the program reads the supporting Excel data through a relative path, no manual path modification is required
